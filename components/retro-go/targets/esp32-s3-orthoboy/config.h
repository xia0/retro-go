 ...
 ****************************************************************************/
#define RG_TARGET_NAME             "ESP32-S3-ORTHOBOY"


/****************************************************************************
 * Status LED                                                               *
 ****************************************************************************/
#define RG_LED_DRIVER               0   // 1 = GPIO
...
#define RG_GPIO_SDSPI_MISO          GPIO_NUM_44
...
#define RG_GAMEPAD_GPIO_MAP {\
    {RG_KEY_UP,     .num = GPIO_NUM_48, .pullup = 1, .level = 0},\
    {RG_KEY_DOWN,   .num = GPIO_NUM_47, .pullup = 1, .level = 0},\
